...
# -------------------------------------------.
asyncio.ensure_future( capture(r"C:\Users\l.scattolin\Desktop\render_test\output.png") )

# HDR capture not working?
asyncio.ensure_future( capture(r"C:\Users\l.scattolin\Desktop\render_test\output.exr", True) )